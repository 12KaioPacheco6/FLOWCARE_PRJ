...
class BancoDeDados
{
    ...
    */ 
    ...
    function __construct($umServidor, $umUsuario, $umaSenha, $umBanco, $umaTabela1, $umaTabela2, $umaTabela3, $umaTabela4){
    ...
    /* 
        function __construct($umServidor, $umUsuario, $umaSenha, $flowcare, $produto, $categoria)
        {
            ...
            $this->senha = $umaSenha;
            $this->flowcare = $flowcare; Deixa para colocar o nome do banco na hora de inserir os dados no construtor
